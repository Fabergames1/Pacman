...
class Game(object):
    def __init__(self):
        ...
        self.menu = Menu(("Iniciar","Sobre","Sair"),font_color = WHITE,font_size=60)
        # Create the player
    ...
    def display_frame(self,screen):
        ...
        if self.game_over:
            if self.about:
                self.display_message(screen,"Classico jogo do pac-man dos anos 80, Criado por Fabergames1")
            ...
            text = self.font.render("Pontos: " + str(self.score),True,GREEN)
